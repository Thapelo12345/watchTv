...
export const userStore = create((set) => ({
  ...
  addUnfinishedShow: (show: {
    programmeName: string;
    programmeSeason?: SEASON;
  }) =>
    set((state: any) => ({
      continueWatching: [...state.continueWatching, show],
    })),
  addWatchedShow: (showName: string) =>
    set((state: any) => ({ watchHistory: [...state.watchHistory, showName] })),
  removeWatchShow: (showName: string) =>
    set((state: any) => ({
      watchHistory: state.watchHistory.filter(
        (show: string) => show !== showName,
      ),
    })),
  addPreferedGenre: (genre: string) =>
    set((state: any) => ({
      userPrefferedGenres: [...state.userPrefferedGenres, genre],
    })),
  removeUnfinishedShow: (showName: string) =>
    set((state: any) => ({
      continueWatching: state.continueWatching.filter(
        (show: { programmeName: string }) => show.programmeName !== showName,
      ),
    })),
  addLikedSeries: (likedSeries: string) =>
    set((state: any) => ({
      userLiked: {
  ...
  addLikedMovies: (likedMovie: string) =>
    set((state: any) => ({
      userLiked: {
  ...
  removeLikedSeries: (removeShow: string) =>
    set((state: any) => ({
  ...
  removeLikedMovies: (removeShow: string) =>
    set((state: any) => ({
      userLiked: {
        ...state.userLiked,
        userMovies: state.userLiked.userMovies.filter(
          (showName: string) => showName !== removeShow,
        ),
      },
    })),
